//from: https://forum.gamemaker.io/index.php?threads/code-bank-share-useful-code.60575/page-3#post-546165

//!!!!: these are used some functions imported from another project, and should be considered defunct
